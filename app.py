...
def repondre(question_brute, forcer_local=False):
    ...
    Si forcer_local=True, l'IA n'est meme pas tentee (utile pour
    restreindre certains plans d'abonnement, ex. le plan Gratuit, au
    seul moteur local sans jamais consommer de credit OpenAI)."""
    if not forcer_local:
